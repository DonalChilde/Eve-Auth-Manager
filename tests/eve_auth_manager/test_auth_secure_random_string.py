...
import eve_auth_manager.auth.secure_random_string as secure_random_string_module
from eve_auth_manager.auth.secure_random_string import generate_secure_random_string

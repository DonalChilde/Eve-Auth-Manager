...
import pfmsoft.eve_auth_manager.auth.request_authentication_code as auth_code_module
from pfmsoft.eve_auth_manager.auth.request_authentication_code import (

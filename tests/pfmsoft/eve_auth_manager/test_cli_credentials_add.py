...
import pfmsoft.eve_auth_manager.cli.credentials.add as add_module
from pfmsoft.eve_auth_manager.cli.credentials.add import add_credentials
from pfmsoft.eve_auth_manager.models import EsiAppCredential
